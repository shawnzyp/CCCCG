...
(function(){
  ...
  /* PLATES (ID -> name, seeds) */
  const PLATES = [
    {id:'TRIBUNAL', name:'The Tribunal', seeds:[
    ...
    {id:'METEOR', name:'The Meteor', seeds:[
    ...
    {id:'NULL_VAULT', name:'The Null Vault', seeds:[
  ...
  function renderCards(){
    ...
    PLATES.forEach(p=>{
      ...
      d.innerHTML = `<h5>${p.name}</h5><div class="somf-badges"><span class="somf-badge">${p.id}</span></div>`;
